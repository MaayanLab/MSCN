...
{
	$dom->getElementsByTagName("width")->item(0)->nodeValue = round($_POST["width"]*0.70*0.75-40);
	$dom->getElementsByTagName("height")->item(0)->nodeValue = round(($_POST["width"]*0.70*0.75-40)*0.75);
}
...
<applet  name = "WordCloud_<?php echo $name;?>" width  = "<?php echo $dom->getElementsByTagName("width")->item(0)->nodeValue;?>px" height = "<?php echo $dom->getElementsByTagName("height")->item(0)->nodeValue;?>px" codebase="<?php echo $path;?>applet/" code="WordCloud.class" archive="WordCloud.jar, jsoup-1.3.3.jar,WordCram.jar,core.jar,plugin.jar" hspace="10px" vspace="10px">
