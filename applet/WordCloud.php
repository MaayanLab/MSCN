...
?>
	<div id="<?php echo $name;?>" name="<?php echo $name;?>">
		...
		$(document).ready(function() {
			display_applet('width',$(window).width(),'<?php echo $path;?>','<?php echo $name;?>');
        });
		</script>
			<div class="form" id="form_applet_<?php echo $name;?>">
				<form method="post">
					...
					<div id="remove_keywords_<?php echo $name;?>">
						<p>
					...
					<div id="appletData_<?php echo $name;?>">
					<p> Click on the words to know in which PubMed articles the words appear.</p>
				</div>
				</form>
			</div>
			<?php if ($input_keywords_weights=="") echo ("<h4>Warning !!!!! no keywords are to display.</h4>")?>
